 ...
 */
@WebServlet("/ValidateWitness2")
public class WitnessValidationUpdateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WitnessValidationUpdateServlet() {
        super();
